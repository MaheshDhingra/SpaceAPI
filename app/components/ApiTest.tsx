      ...
      <form onSubmit={handleSubmit}>
        ...
        {params.map((param) => (
          <div key={param} className="mb-4">
            <label className="block text-sm font-medium mb-1" htmlFor={`${endpoint}-${param}`}>{param}</label>
            <input
              id={`${endpoint}-${param}`}
              type="text"
        ...
        {(method === 'POST' || method === 'PUT') && (
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1" htmlFor={`${endpoint}-body`}>Body</label>
            <textarea
              id={`${endpoint}-body`}
              value={body}
