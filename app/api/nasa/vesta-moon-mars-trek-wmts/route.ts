...
export async function GET(req: Request) {
  try {
    ...
    let url = `https://trek.nasa.gov/tiles/${tileMatrixSet}/wmts?request=GetTile&service=WMTS&version=1.0.0&layer=${tileMatrixSet}&style=default&format=${format}&TileMatrixSet=${tileMatrixSet}&TileMatrix=${tileMatrix}&TileRow=${tileRow}&TileCol=${tileCol}&api_key=${NASA_API_KEY}`;
